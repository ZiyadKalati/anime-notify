...
python3 $pathToHere/pyscripts/nameToQuery.py
while read -r query
do
    ...
    python3 $pathToHere/pyscripts/queryToName.py $query
...
python3 $pathToHere/pyscripts/checkIfAlreadyNotified.py
python3 $pathToHere/pyscripts/sendNotification.py
